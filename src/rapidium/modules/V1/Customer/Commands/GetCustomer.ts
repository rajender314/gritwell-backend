...
/**
 * Command class for GetCustomer
 */
export class GetCustomer extends BaseCommand {
  public id: string;
  ...
  public path = __dirname.replace(process.cwd(), '.') + '/GetCustomer.ts';
  /**
    * @param {data} data
   */
  constructor(data: any) {
    ...
    this.page = data.query.page ? parseInt(data.query.page) : 0;
